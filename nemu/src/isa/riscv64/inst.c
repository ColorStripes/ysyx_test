...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulw   , R, R(dest) = SEXT(BITS((src1 * src2), 31, 0), 32));
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 00100 11", srai   , I, R(dest) = (long int)src1 >> src2);
  ...
  INSTPAT("0000000 ????? ????? 100 ????? 00100 11", xori   , I, R(dest) = src1 ^ src2);
