...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 01100 11", sra    , R, R(dest) = (int64_t)src1 >> src2);
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 01110 11", divw   , R, R(dest) = SEXT(((int64_t)BITS(src1, 31, 0) / (int64_t)BITS(src2, 31, 0)), 32));
  ...
  INSTPAT("0000000 ????? ????? 010 ????? 00100 11", slti   , I, R(dest) = (((int64_t)src1 < (int64_t)src2) ? 1 : 0));
